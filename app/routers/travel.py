...
def get_bus_journey_info(origin: str, destination: str, accepted_buses: str | None = None) -> List[BusInfo]:
  ...
  bus_directions_response = get_directions_response(TravelMode.BUS, origin_point, destination_point)
  formatted = format_bus_directions_response(bus_directions_response, formatted_accepted_buses)
